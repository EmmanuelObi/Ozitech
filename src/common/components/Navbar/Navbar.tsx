...
const Navbar = () => {
  return (
    <div className="absolute z-10 lg:fixed top-0 w-full bg-transparent py-6 max-w-6xl px-6 lg:px-0 flex items-center justify-between border-b-2 border-nav-border">
